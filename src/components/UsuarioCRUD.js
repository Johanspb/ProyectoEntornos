...
import { getUsuarios, createUsuario, updateUsuario, deleteUsuario } from '../services/api'; // Asegúrate de que tienes estas funciones
      ...
      <ul>
        {usuarios.map((usuario) => (
          <li key={usuario.cedula}>
            ...
            <button onClick={() => handleDelete(usuario.cedula)}>Eliminar</button>
          </li>
        ))}
      </ul>
